...
import 'package:akiba/widgets/components/register_components/verify_code_widget.dart';
...
class VerifyNumberView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VerifyNumberView> createState() => _VerifyNumberViewState();
}

class _VerifyNumberViewState extends ConsumerState<VerifyNumberView> {
  String enteredCode = '';
  int resendTimer = 59;
  Timer? timer;
